...
<body>
  ...
  <div class="main">
    <div class="container text-center">
      ...
      <form class="form-wrapper" action="update.php" method="post">
        <h2>問題作成</h2>
        <div class="input-area">
          <label for="question">問題文</label>
          <textarea name="question" cols="30" rows="10"><?php echo $quiz['question']; ?></textarea>
        </div>
        <div class="input-area">
          <label for="choices_1">選択肢1</label>
          <input type="text" name="choices_1" value="<?php echo $quiz['choices_1']; ?>">
        </div>
        <div class="input-area">
          <label for="choices_2">選択肢2</label>
          <input type="text" name="choices_2" value="<?php echo $quiz['choices_2']; ?>">
        </div>
        <div class="input-area">
          <label for="choices_3">選択肢3</label>
          <input type="text" name="choices_3" value="<?php echo $quiz['choices_3']; ?>">
        </div>
        <div class="input-area">
          <label for="choices_4">選択肢4</label>
          <input type="text" name="choices_4" value="<?php echo $quiz['choices_4']; ?>">
        </div>
        <div class="input-area">
          <label for="correct">答え</label>
          <input type="text" name="correct" placeholder="答えの選択肢をここにコピペ" value="<?php echo $quiz['correct']; ?>">
        </div>
        <div class="input-area">
